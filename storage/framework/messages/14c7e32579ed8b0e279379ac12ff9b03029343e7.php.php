...
class UsersController extends Controller
{
    ...
    public function details(
        ...
        ReportsCollection            $reportsCollection,
        AllocationCriteriaRepo       $allocationCriteriaRepo,
        AllocationCriteriaCollection $allocationCriteriaCollection,
        ...
        if (!is_null($user)) {
            try {
                ...
                if ($wallet->code == Codes::$not_found) {
                    ...
                    $allocationCriteria = $allocationCriteriaRepo->all();
                    $allocationCriteriaCollection->formatAll($allocationCriteria);
                    ...
                    if ($bonus) {
                        $campaigns = $campaignsRepo->getByStatus($currency);
