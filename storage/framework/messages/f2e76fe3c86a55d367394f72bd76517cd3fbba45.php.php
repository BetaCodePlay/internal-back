...
<?php $__env->startSection('content'); ?>
    <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
        <header
            ...
            <div class="media">
                ...
                <div class="media-body d-flex justify-content-end">
                    <a href="<?php echo e(route('betpay.clients.accounts.create')); ?>" class="btn u-btn-3d u-btn-primary float-right">
        ...
        <div class="card-block g-pa-15">
            <form id="client-account-form" method="post" action="<?php echo e(route('betpay.clients.accounts.store')); ?>">
                <div class="row">
                    <div class="col-md-4">
