                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country[]" id="country" class="form-control" multiple="multiple">
                                        ...
                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($country->iso); ?>" <?php if(isset($segment->filter->country)): ?>
                                                <?php echo e(in_array($country->iso, $segment->filter->country) ? 'selected': ''); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="exclude_country[]" id="exclude_country" class="form-control" multiple="multiple">
                                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($country->iso); ?>" <?php if(isset($segment->filter->exclude_country)): ?>
                                                <?php echo e(in_array($country->iso, $segment->filter->exclude_country) ? 'selected': ''); ?>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="balance_options" id="balance_options" class="form-control">
                                        <option value="<=" <?php if(isset($segment->filter->balance_options)): ?>
                                            <?php echo e($segment->filter->balance_options == '<=' ? 'selected': ''); ?>

                                            <?php endif; ?>>
                                            <?php echo e(_i('Less than or equal to')); ?>
                                        ...
                                        <option value=">=" <?php if(isset($segment->filter->balance_options)): ?>
                                            ...
                                            <?php endif; ?>>
                                            <?php echo e(_i('Greater than or equal to')); ?>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="balance" id="balance" class="form-control" min="0" value="<?php if(isset($segment->filter->balance)): ?><?php echo e($segment->filter->balance); ?><?php endif; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="deposits_options" id="deposits_options" class="form-control">
                                        <option value="<=" <?php if(isset($segment->filter->deposits_options)): ?>
                                            <?php echo e($segment->filter->deposits_options == '<=' ? 'selected': ''); ?>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="deposits" id="deposits" value="<?php if(isset($segment->filter->deposits)): ?><?php echo e($segment->filter->deposits); ?><?php endif; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="last_login_options" id="last_login_options" class="form-control">
                                        <option value="<=" <?php if(isset($segment->filter->last_login_options)): ?>
                                            <?php echo e($segment->filter->last_login_options == '<=' ? 'selected': ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="last_login" id="last_login"
                                               class="form-control datepicker" autocomplete="off" value="<?php if(isset($segment->last_login)): ?><?php echo e($segment->last_login); ?><?php endif; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="last_deposit_options" id="last_deposit_options" class="form-control">
                                        <option value="<=" <?php if(isset($segment->filter->last_deposit_options)): ?>
                                            <?php echo e($segment->filter->last_deposit_options == '<=' ? 'selected': ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="last_deposit" id="last_deposit"
                                               class="form-control datepicker" autocomplete="off" value="<?php if(isset($segment->last_deposit)): ?><?php echo e($segment->last_deposit); ?><?php endif; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="last_withdrawal_options" id="last_withdrawal_options" class="form-control">
                                        <option value="<=" <?php if(isset($segment->filter->last_withdrawal_options)): ?>
                                            <?php echo e($segment->filter->last_withdrawal_options == '<=' ? 'selected': ''); ?>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="registration_options" id="registration_options" class="form-control">
                                        <option value="<=" <?php if(isset($segment->filter->registration_options)): ?>
                                            <?php echo e($segment->filter->registration_options == '<=' ? 'selected': ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="registration_date" id="registration_date"
                                               class="form-control datepicker" autocomplete="off" value="<?php if(isset($segment->registration_date)): ?><?php echo e($segment->registration_date); ?><?php endif; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="played_options" id="played_options" class="form-control">
                                        <option value="<=" <?php if(isset($segment->filter->played_options)): ?>
                                            <?php echo e($segment->filter->played_options == '<=' ? 'selected': ''); ?>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="played" id="played" class="form-control" value="<?php if(isset($segment->filter->played)): ?><?php echo e($segment->filter->played); ?><?php endif; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-10">
                    ...
                    <div class="card-block g-pa-15 g-pb-5">
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="full_profile"><?php echo e(_i('Full profile')); ?></label>
                                    <select name="full_profile" id="full_profile" class="form-control">
                                        <option value="1" <?php if(isset($segment->filter->full_profile)): ?>
                                            <?php echo e($segment->filter->full_profile == '1' ? 'selected': ''); ?>

                                            <?php endif; ?>>
                                            <?php echo e(_i('Completed')); ?>

                                        </option>
                                        <option value="0" <?php if(isset($segment->filter->full_profile)): ?>
                                            <?php echo e($segment->filter->full_profile == '0' ? 'selected': ''); ?>

                                            <?php endif; ?>>
                                            <?php echo e(_i('Incomplete')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="currency[]" id="currency" class="form-control" multiple="multiple">
                                        ...
                                        <?php $__currentLoopData = $currency_client; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($currency); ?>" <?php if(isset($segment->filter->currency)): ?>
                                                <?php echo e(in_array($currency, $segment->filter->currency) ? 'selected': ''); ?>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option value="true" <?php echo e($segment->filter->status == '1' ? 'selected': ''); ?>>
                                            <?php echo e(_i('Active')); ?>

                                        </option>
                                        <option value="false" <?php echo e($segment->filter->status == '0' ? 'selected': ''); ?>>
                                            <?php echo e(_i('Blocked')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="language[]" id="language" class="form-control" multiple="multiple">
                                        ...
                                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($language['iso']); ?>" <?php if(isset($segment->filter->language)): ?>
                                                <?php echo e(in_array($language['iso'], $segment->filter->language) ? 'selected': ''); ?>
                ...
                <header
                    ...
                    <div class="media">
                        ...
                        <div class="justify-content-end g-ml-10 g-pl-10">
                            <input type="hidden" name="id" value="<?php echo e($segment->id); ?>">
                            <input type="hidden" name="filter" id="filter" value="<?php echo e(json_encode($segment->filter)); ?>">
                            <button id="update" class="btn u-btn-3d u-btn-primary" data-loading-text="<?php echo e(_i('Please wait...')); ?>">
                                <i class="hs-admin-reload"></i>
                                <?php echo e(_i('Update segment')); ?>
