...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <table class="table table-bordered table-responsive-sm w-100" id="documents-table"
                           data-route="<?php echo e(route('users.documents-verifications-data')); ?>">
                        <thead>
                        <tr>
    ...
    <?php echo $__env->make('back.users.modals.document-approved', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('back.users.modals.watch-document', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('back.users.modals.document-edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
