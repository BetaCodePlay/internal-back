...
<?php $__env->startSection('content'); ?>
        ...
        <div class="card-block g-pa-15">
            ...
            <table class="table table-bordered w-100" id="transactions-table" data-route="<?php echo e(route('betpay.transactions.data', [$payment_method, $provider, $transaction_type])); ?>">
                ...
                <tr>
                    ...
                    <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                        <?php echo e(_i('VES amount')); ?>

                    </th>
                    <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                        <?php echo e(_i('USD amount')); ?>
                    ...
                    <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                        <?php echo e(_i('Origin bank')); ?>

                    </th>
                    <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                        <?php echo e(_i('Destination bank')); ?>
    ...
    <?php echo $__env->make('back.betpay.ves-to-usd.modals.process-credit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
