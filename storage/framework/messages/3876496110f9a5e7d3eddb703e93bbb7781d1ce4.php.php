            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered w-100" id="redeemed-rewards-table"
                               data-route="<?php echo e(route('store.reports.redeemed-rewards-data')); ?>">
                            <thead>
                            <tr>
