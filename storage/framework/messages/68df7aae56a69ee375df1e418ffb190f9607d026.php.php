...
<?php $__env->startSection('content'); ?>
    <div class="container-login" data-multi="<?php echo e($envType ? 'true' : 'false'); ?>">
        <div class="wrap-login">
            <?php if(\Dotworkers\Configurations\Configurations::getWhitelabel() == 2): ?>
            ...
            <form class="login-form validate-form" action="<?php echo e(route('auth.authenticate')); ?>" id="login-form">
                ...
                <div class="login-form-ex">
                    ...
                    <div class="wrap-input-subtitle">
                        <?php echo e(_i("Choose which method you prefer to log in.")); ?>
                    ...
                    <div class="login-form-line">
                        ...
                        <div class="container-login-form-btn">
                            <button class="btn-login disabled" id="login" type="button" data-loading-text="<i class='fa fa-spin fa-spinner'></i> <?php echo e(_i('Please wait...')); ?>">
                                <?php echo e(_i('Login')); ?>
