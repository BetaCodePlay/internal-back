...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('back.layout.litepicker-with-processing-status', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
        ...
        <div class="card-block g-pa-15">
            ...
            <div class="table-responsive">
                <table class="table table-bordered w-100" id="debit-table" data-route="<?php echo e(route('betpay.reports.debit-data')); ?>">
                    <thead>
                    <tr>
