...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="email_templates_type_id"><?php echo e(_i('Email templates type')); ?></label>
                                <select name="email_templates_type_id" id="email_templates_type_id" class="form-control" >
                                    <option value=""><?php echo e(_i('Select...')); ?></option>
                                    <option value="<?php echo e(\App\CRM\Enums\EmailTemplatesTypes::$email_template_transactions); ?>"><?php echo e(_i('Transactions')); ?></option>
            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                <header
                    ...
                    <div class="media">
                        ...
                        <div class="media-body d-flex justify-content-end">
                            <a href="<?php echo e(route('email-templates-transaction.create')); ?>" class="btn u-btn-3d u-btn-primary float-right">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered w-100" id="email-templates-transaction-table" data-route="<?php echo e(route('email-templates-transaction.all')); ?>">
                            <thead>
                            <tr>
    ...
    <?php echo $__env->make('back.crm.email-templates.modals.preview', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(function () {
            ...
            emailTemplates.allTransactions();
