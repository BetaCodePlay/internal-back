        ...
        <div class="col-md-12">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    <form action="<?php echo e(route('security.manage-store-role-users')); ?>" id="save-form" method="post">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="roles[]" id="roles" class="form-control" multiple data-placeholder="<?php echo e(_i('Select ...')); ?>">
                    ...
                    <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                        ...
                        <div class="card-block g-pa-15">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered w-100" id="roles-users-table" data-route="<?php echo e(route('security.role-users-data')); ?>">
                                    <thead>
                                    <tr>
