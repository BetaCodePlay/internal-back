                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select name="allocation_criteria" id="allocation_criteria" class="form-control" data-route="<?php echo e(route('bonus-system.campaigns.allocation-criteria-types')); ?>">
                                    <option value="*"><?php echo e(_i('All options')); ?></option>
                                    <option value=<?php echo e(\Dotworkers\Bonus\Enums\AllocationCriteria::$registration); ?>><?php echo e(_i('Registration')); ?></option>
                                    <option value=<?php echo e(\Dotworkers\Bonus\Enums\AllocationCriteria::$deposit); ?>><?php echo e(_i('Deposit')); ?></option>
                                    <option value=<?php echo e(\Dotworkers\Bonus\Enums\AllocationCriteria::$complete_profile); ?>><?php echo e(_i('Complete profile')); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="col">
            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                <div class="card-block g-pa-15">
                    ...
                    <table class="table table-bordered table-responsive-sm w-100" id="campaigns-table"
                           data-route="<?php echo e(route('bonus-system.reports.campaigns-overview-data')); ?>">
                        <thead>
                        <tr>
                            ...
                            <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                                <?php echo e(_i('Criteria met')); ?>

                            </th>
                            <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                                <?php echo e(_i('Claimed')); ?>
