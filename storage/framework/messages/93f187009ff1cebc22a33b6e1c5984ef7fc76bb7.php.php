...
<?php $__env->startSection('content'); ?>
                ...
                <header
                    ...
                    <div class="media">
                        <h3 class="d-flex text-uppercase g-font-size-12 g-font-size-default--md g-color-black g-mr-10 mb-0">
                            <?php echo e(_i('Filter client account payment limit')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="payments" id="payment" class="form-control">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="transaction_type" id="transaction_type" class="form-control">
                                    <option value=""><?php echo e(_i('All transaction type')); ?></option>
                                    <option
            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered w-100" id="limit-client-table"
                               data-route="<?php echo e(route('betpay.clients.accounts.payment-limits.limit-data')); ?>">
                            <thead>
                            <tr>
                                ...
                                <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                                    <?php echo e(_i('Minimum')); ?>

                                </th>
                                <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                                    <?php echo e(_i('Maximum')); ?>
    ...
    <?php echo $__env->make('back.betpay.clients.modals.update-limit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
