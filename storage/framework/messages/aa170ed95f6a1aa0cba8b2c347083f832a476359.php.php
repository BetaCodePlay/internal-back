        ...
        <div class="modal-content">
            <form action="<?php echo e(route('betpay.process-debit')); ?>" method="post" id="process-debit-form">
                        ...
                        <select name="client_account" id="client_account" class="form-control">
                            ...
                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>}
                                <option value="<?php echo e($account->id); ?>">
                                    <?php echo e($account->data->name); ?> - <?php echo e($account->data->phone); ?>
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="payment_method" value="<?php echo e(\Dotworkers\Configurations\Enums\PaymentMethods::$bizum); ?>">
                    <input type="hidden" name="provider" value="<?php echo e(\Dotworkers\Configurations\Enums\Providers::$bizum); ?>">
