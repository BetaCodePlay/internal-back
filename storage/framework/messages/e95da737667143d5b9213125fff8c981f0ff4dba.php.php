...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col">
            <div class="noty_bar noty_type__warning noty_theme__unify--v1--dark g-mb-25">
                <div class="noty_body">
                    ...
                    <div>
                        <p>
                            <?php echo e(_i('This report shows the list of withdrawals made in a certain date range, allowing them to be filtered by status.')); ?>
    ...
    <input type="hidden" id="transaction_type" value="<?php echo e(\Dotworkers\Configurations\Enums\TransactionTypes::$debit); ?>">
