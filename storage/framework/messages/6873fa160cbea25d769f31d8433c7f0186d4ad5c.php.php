    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    <form action="<?php echo e(route('security.exclude-roles-users-data')); ?>" method="post" id="exclude-roles-user-form">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                <label for="user"><?php echo e(_i('User')); ?></label>
                                    <select class="form-control select2 roleselect user" id="user" name="user"
                                            data-route="<?php echo e(route('users.search-username')); ?>">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                    <label for="roles"><?php echo e(_i('Roles')); ?></label>
                                    <select name="roles[]" id="roleselect" class="form-control select2 roleselect user " multiple
                                    data-route="<?php echo e(route('security.manage-role')); ?>"
                                    >
        ...
        <div class="col-md-12">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                <header class="card-header g-bg-transparent g-brd-gray-light-v7 g-px-15 g-pt-15 g-pt-20--sm g-pb-10 g-pb-15--sm">
                    <div class="media">
                        <h3 class="d-flex text-uppercase g-font-size-12 g-font-size-default--md g-color-black g-mr-10 mb-0 title">
                            <?php echo e(_i('Excluded roles users')); ?>
                ...
                <div class="card-block g-pa-15">
                    <table class="table table-bordered table-responsive-sm w-100" id="exclude-roles-users-table" data-route="<?php echo e(route('security.exclude-roles-users-list')); ?>">
                        <thead>
                        <tr>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(function () {
            ...
            security.select2Roles('<?php echo e(_i('Select role')); ?>');
