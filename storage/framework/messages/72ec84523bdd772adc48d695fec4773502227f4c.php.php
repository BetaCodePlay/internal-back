...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('featured-sliders.store')); ?>" id="sliders-form" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6">
                    ...
                    <header
                        ...
                        <div class="media">
                            ...
                            <div class="media-body d-flex justify-content-end">
                                <a href="<?php echo e(route('featured-sliders.index', [$template_element_type])); ?>" class="btn u-btn-3d u-btn-primary float-right">
