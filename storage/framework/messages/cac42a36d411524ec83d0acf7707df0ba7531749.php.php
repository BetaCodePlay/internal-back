        ...
        <div class="col-md-12">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    <div class="row">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', [\Dotworkers\Security\Enums\Permissions::$whitelabels_totals])): ?>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="currency"><?php echo e(_i('whitelabel')); ?></label>
                                    <select name="whitelabel" id="whitelabel" class="form-control"
                                            data-route="<?php echo e(route('whitelabels.currency-by-whitelabel')); ?>">
                                        <option value=""><?php echo e(_i('All whitelabels')); ?></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="transaction_type" id="transaction_type" class="form-control">
                                    <option value=""><?php echo e(_i('All types')); ?></option>
                                    <option
                                        value="<?php echo e(\Dotworkers\Configurations\Enums\TransactionTypes::$credit); ?>"><?php echo e(_i('Credit')); ?></option>
                                    <option
                                        value="<?php echo e(\Dotworkers\Configurations\Enums\TransactionTypes::$debit); ?>"><?php echo e(_i('Debit')); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered w-100" id="manual-adjustments-table"
                               data-route="<?php echo e(route('reports.financial.manual-adjustments-data')); ?>">
                            <thead>
                            <tr>
                                ...
                                <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                                    <?php echo e(_i('Transaction type')); ?>
