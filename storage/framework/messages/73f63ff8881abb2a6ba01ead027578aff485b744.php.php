...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="whitelabel" id="whitelabel" class="form-control" data-route="<?php echo e(route('whitelabels.currency-by-whitelabel')); ?>">
            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <table class="table table-bordered table-responsive-sm w-100" id="whitelabels-active-providers-table"
                           data-route="<?php echo e(route('reports.whitelabels-active-providers-data')); ?>">
                        <thead>
                        <tr>
    ...
    <?php echo $__env->make('back.reports.products.modals.update-percentage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
