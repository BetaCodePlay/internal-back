                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="currencies[]" id="currencies" class="form-control" multiple data-route="<?php echo e(route('bonus-system.campaigns.provider-types')); ?>" data-payments-route="<?php echo e(route('bonus-system.campaigns.payment-methods')); ?>">
                        ...
                        <table class="table align-middle g-mb-0">
                                ...
                                <td width="20%">
                                    <div class="form-check">
                                        <label class="u-check g-pl-25">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="allocation_criteria[]" value="<?php echo e(\Dotworkers\Bonus\Enums\AllocationCriteria::$registration); ?>" id="registration">
                            ...
                            <tr>
                                <td>
                                    <div class="form-check">
                                        <label class="u-check g-pl-25">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="allocation_criteria[]" value="<?php echo e(\Dotworkers\Bonus\Enums\AllocationCriteria::$complete_profile); ?>">
                                            <div class="u-check-icon-checkbox-v4 g-absolute-centered--y g-left-0">
                                                <i class="fa" data-check-icon="&#xf00c"></i>
                                            </div>
                                ...
                                <td>
                                    <div class="form-check">
                                        <label class="u-check g-pl-25 disabled">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="allocation_criteria[]" id="deposits" disabled value="<?php echo e(\Dotworkers\Bonus\Enums\AllocationCriteria::$deposit); ?>">
                                            <div class="u-check-icon-checkbox-v4 g-absolute-centered--y g-left-0">
                                                <i class="fa" data-check-icon="&#xf00c"></i>
                                            </div>
                                ...
                                <td>
                                    <div class="deposits-table d-none">
                                        <table class="table table-bordered">
                                            <?php $__currentLoopData = $whitelabel_currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="deposits-row deposit-row-<?php echo e($currency->iso); ?> d-none">
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="deposit_types"><?php echo e(_i('Deposit type')); ?></label>
                                                                    <select name="deposit_types[<?php echo e($currency->iso); ?>]" class="form-control">
                                                                        <option value="<?php echo e(\Dotworkers\Bonus\Enums\DepositTypes::$first); ?>">
                                                                            <?php echo e(_i('First')); ?>

                                                                        </option>
                                                                        <option value="<?php echo e(\Dotworkers\Bonus\Enums\DepositTypes::$next); ?>">
                                                                            <?php echo e(_i('Next')); ?>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="min_deposits"><?php echo e(_i('Minimum')); ?></label>
                                                                    <input type="number" min="0" name="min_deposits[<?php echo e($currency->iso); ?>]" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="include_payment_methods"><?php echo e(_i('Include payment methods')); ?></label>
                                                                    <select name="include_payment_methods[<?php echo e($currency->iso); ?>][]" class="form-control" multiple id="include-payment-methods-<?php echo e($currency->iso); ?>">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="exclude_payment_methods[<?php echo e($currency->iso); ?>][]" class="form-control" multiple id="exclude-payment-methods-<?php echo e($currency->iso); ?>">
                                                                        <option value="<?php echo e(\Dotworkers\Configurations\Enums\Providers::$dotworkers); ?>">
                                                                            <?php echo e(_i('Manual transactions')); ?>
                        ...
                        <table class="table align-middle g-mb-0">
                            <tr>
                                <td width="20%">
                                    ...
                                    <div class="form-group g-mb-10">
                                        <label class="u-check g-pl-25 disabled">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" name="bonus_type_awarded" id="deposit-percentage" type="radio" disabled value="<?php echo e(\Dotworkers\Bonus\Enums\BonusTypeAwarded::$percentage); ?>">
                                            <div class="u-check-icon-font g-absolute-centered--y g-left-0">
                                                <i class="fa" data-check-icon="" data-uncheck-icon=""></i>
                                            </div>
