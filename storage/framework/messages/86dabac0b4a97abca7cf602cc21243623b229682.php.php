                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 bonus-code <?php echo e(!isset($campaign->data->code) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bonus_code" id="bonus_code" class="form-control text-uppercase" value="<?php echo e($campaign->data->code ?? ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 min <?php echo e(!isset($campaign->data->min) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="min_deposit" id="min_deposit" class="form-control" value="<?php echo e($campaign->data->min ?? ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 deposits-quantity <?php echo e(!isset($campaign->data->deposits_quantity) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="deposits_quantity" id="deposits_quantity" autocomplete="off" value="<?php echo e($campaign->data->deposits_quantity ?? ''); ?>">
                                </div>
                            </div>
                    ...
                    <div class="card-block g-pa-15">
                        <div class="col-md-12 bonus <?php echo e(!isset($campaign->data->amount) ? 'd-none' : ''); ?>">
                            <div class="form-group">
                                ...
                                <input type="text" name="bonus" id="bonus" class="form-control" value="<?php echo e($campaign->data->amount ?? ''); ?>">
                            </div>
                        </div>
                        <div class="col-md-12 deposit-percentage <?php echo e(!isset($campaign->data->percentage) ? 'd-none' : ''); ?>">
                            <div class="form-group">
                                ...
                                <input type="text" name="percentage" id="percentage" class="form-control" value="<?php echo e(isset($campaign->data->percentage) ? $campaign->data->percentage * 100 : ''); ?>">
                            </div>
                        </div>
                        <div class="col-md-12 bonus-limit <?php echo e(!isset($campaign->data->limit) ? 'd-none' : ''); ?>">
                            <div class="form-group">
                                ...
                                <input type="text" name="limit" id="limit" class="form-control" value="<?php echo e($campaign->data->limit ?? ''); ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="max_balance_convert"><?php echo e(_i('Amount that can be converted into a real balance')); ?></label>
                                <input type="text" name="max_balance_convert" id="max_balance_convert" class="form-control" value="<?php echo e($campaign->data->max_balance_convert ?? ''); ?>" placeholder="<?php echo e(_i('Optional')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
