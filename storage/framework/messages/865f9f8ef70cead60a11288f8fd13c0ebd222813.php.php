            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option value=""><?php echo e(_i('Select...')); ?></option>
                                    <option value="<?php echo e(\App\DotSuite\Enums\FreeSpinsStatus::$enable); ?>"><?php echo e(_i('Activated')); ?>

                                    </option>
                                    <option value="<?php echo e(\App\DotSuite\Enums\FreeSpinsStatus::$disable); ?>"><?php echo e(_i('Desactivate')); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="code_reference"><?php echo e(_i('Code reference')); ?></label>
                ...
                <div class="card-block g-pa-15">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered w-100" id="free-spins-table"
                               data-route="<?php echo e(route('dot-suite.free-spins.reports.free-spins-data')); ?>">
                            <thead>
                            <tr>
                                ...
                                <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                                    <?php echo e(_i('Start date')); ?>

                                </th>
                                <th class="g-font-weight-600 g-color-gray-dark-v6 g-brd-top-none">
                                    <?php echo e(_i('End date')); ?>
