...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('configurations.registration-login.update')); ?>" method="post" id="registration-login-form"
          data-registration-login-route="<?php echo e(route('configurations.registration-login.data')); ?>">
        <div class="row">
            <div class="col-md-3">
                    ...
                    <header class="card-header g-bg-transparent g-brd-gray-light-v7 g-px-15 g-pt-15 g-pt-20--sm g-pb-10 g-pb-15--sm">
                        <div class="media">
                            <h3 class="d-flex text-uppercase g-font-size-12 g-font-size-default--md g-color-black g-mr-10 mb-0 title">
                                <?php echo e(_i('Registration settings')); ?>
                            ...
                            <div class="col-md-6">
                                <div class="noty_bar noty_type__warning noty_theme__unify--v1--dark g-mb-25">
                                    <div class="noty_body">
                                        ...
                                        <div>
                                            <p>
                                                <?php echo e(_i('These settings allow you to define whether to allow user registration on the website. You can also specify if you want to enable registration through social networks')); ?>
                            ...
                            <div class="col-md-6">
                                <div class="noty_bar noty_type__warning noty_theme__unify--v1--dark g-mb-25">
                                    <div class="noty_body">
                                        ...
                                        <div>
                                            <p>
                                                <?php echo e(_i('This configuration allows you to define whether to allow user login on the website. You can also specify if you want to enable login through social networks')); ?>
