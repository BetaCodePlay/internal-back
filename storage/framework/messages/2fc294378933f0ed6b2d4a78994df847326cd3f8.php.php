                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="whitelabel"><?php echo e(_i('Whitelabels')); ?></label>
                                <select name="whitelabel[]" id="whitelabel" class="form-control" data-placeholder="<?php echo e(_i('Select...')); ?>" multiple>
            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <table class="table table-bordered table-responsive-sm w-100" id="whitelabels-totals-table"
                           data-route="<?php echo e(route('reports.whitelabels-totals-data-new')); ?>">
                        <thead>
                        <tr>
