    ...
    <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
        <header
            ...
            <div class="media">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('access', [\Dotworkers\Security\Enums\Permissions::$referral_create])): ?>
                    <div class="media-body d-flex justify-content-end">
                        <a href="<?php echo e(route('referrals.create')); ?>" class="btn u-btn-3d u-btn-primary float-right">
            ...
            <div class="card-block g-pa-15">
                <div class="table-responsive">
                    <table class="table table-bordered w-100" id="referral-users-list-table"
                           data-route="<?php echo e(route('referrals.referral-users-list-data')); ?>">
                        <thead>
                        <tr>
