...
<?php $__env->startSection('content'); ?>
    <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
        ...
        <form action="<?php echo e(route('email-templates.update')); ?>" id="email-templates-form" method="post">
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(function() {
            ...
            emailTemplates.update(<?php echo json_encode($template->metadata, 15, 512) ?>, <?php echo json_encode($template->content, 15, 512) ?>);
        });
    </script>
<?php $__env->stopSection(); ?>
