            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <div class="table-responsive">
                        <input type="hidden" name="provider" id="provider" value="<?php echo e(\Dotworkers\Configurations\Enums\PaymentMethods::$just_pay); ?>">
                        <input type="hidden" name="type" id="type" value="<?php echo e(\Dotworkers\Configurations\Enums\TransactionTypes::$credit); ?>">
                        <table class="table table-bordered w-100" id="credit-table" data-route="<?php echo e(route('reports.transactions-data')); ?>">
                            <thead>
                            <tr>
