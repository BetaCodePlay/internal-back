    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><span class="font-weight-bold text-form"><?php echo e(_i('Are you sure you want to block the agent?')); ?></span> <span class="username-form"></span></p>
                <p><?php echo e(_i('Select the reason to prevent this account from taking any further action.')); ?></p>
                <div class="form">
                    <div class="row">
                        <div class="col-12 col-lg-6" id="lockTypeAll">
                            <label><?php echo e(_i('Type')); ?></label>
                            <select class="form-control" id="userLockType">
                                <option value="<?php echo e(route('agents.block')); ?>" id="lockTypeThis"><?php echo e(_i('Only this user')); ?></option>
                                <option value="<?php echo e(route('agents.role.lock-profile')); ?>"><?php echo e(_i('This user and all its dependent users')); ?></option>
                            </select>
                        </div>

                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                <label><?php echo e(_i('Reason')); ?></label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-transparent" data-dismiss="modal"
                        data-lock="<?php echo e(_i('Cancel lock')); ?>"
                        data-unlock="<?php echo e(_i('Cancel unlock')); ?>"
                ...
                <button type="button" class="btn btn-theme lockUser"
                        data-lock="<?php echo e(_i('Ready! Lock')); ?>"
                        data-unlock="<?php echo e(_i('Ready! Unlock')); ?>"
                        data-loading-text="<i class='fa fa-spin fa-spinner'></i> <?php echo e(_i('Please wait...')); ?>">
                </button>
            </div>
        </div>
