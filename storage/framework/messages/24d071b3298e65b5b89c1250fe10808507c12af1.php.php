...
<?php $__env->startSection('content'); ?>
    ...
    <input type="hidden" name="paymentMethod" id="paymentMethod" value="<?php echo e($payment_method); ?>">
    ...
    <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
        ...
        <div class="card-block g-pa-15">
            ...
            <div class="table-responsive">
                <table class="table table-bordered w-100" id="credit-table" data-route="<?php echo e(route('betpay.reports.credit-data')); ?>">
                    <thead>
                    <tr>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(function () {
            ...
            betPay.creditTransactionsReport();
        });
    </script>
<?php $__env->stopSection(); ?>
