        ...
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="internal_name" id="internal_name" class="form-control" value="<?php echo e($campaign->name); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="start_date"><?php echo e(_i('Start date')); ?></label>
                                    <input type="text" name="start_date" id="start_date" class="form-control datetimepicker" autocomplete="off" value="<?php echo e($campaign->start); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="end_date"><?php echo e(_i('Finish date')); ?></label>
                                    <input type="text" name="end_date" id="end_date" class="form-control datetimepicker" autocomplete="off" value="<?php echo e($campaign->end); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="complete_profile"><?php echo e(_i('Does the user have to complete the profile?')); ?></label>
                                    <select name="complete_profile" id="complete_profile" class="form-control" disabled>
                                        <option value="true" <?php echo e($campaign->data->complete_profile ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Yes')); ?>

                                        </option>
                                        <option value="false" <?php echo e(!$campaign->data->complete_profile ? 'selected' : ''); ?>>
                                            <?php echo e(_i('No')); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="currency" id="currency" class="form-control" data-route="<?php echo e(route('bonus-system.campaigns.provider-types')); ?>" data-payments-route="<?php echo e(route('bonus-system.campaigns.payment-methods')); ?>" disabled>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="allocation_criteria" id="allocation_criteria" class="form-control" disabled>
                                        <?php $__currentLoopData = $allocation_criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($criteria->id); ?>" <?php echo e($criteria->id == $campaign->allocation_criteria_id ? 'selected' : ''); ?>>
                            ...
                            <input type="hidden" name="allocation_criteria_select" id="allocation_criteria_select" value=" <?php echo e($campaign->allocation_criteria_id); ?>">
                            <div class="col-md-4 bonus-code <?php echo e(!isset($campaign->data->code) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    <label for="bonus_code"><?php echo e(_i('Bonus code')); ?></label>
                                    <input type="text" name="bonus_code" id="bonus_code" class="form-control text-uppercase" value="<?php echo e($campaign->data->code ?? ''); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 bonus-type <?php echo e(!isset($campaign->data->bonus_type) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    ...
                                    <select name="bonus_type" id="bonus_type" class="form-control" disabled>
                                        <option value="1" <?php echo e(isset($campaign->data->bonus_type) && $campaign->data->bonus_type == 1 ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Fixed amount')); ?>

                                        </option>
                                        <option value="2" <?php echo e(isset($campaign->data->bonus_type) && $campaign->data->bonus_type == 2 ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Percentage with limit')); ?>

                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 min <?php echo e(!isset($campaign->data->min) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    <label for="min_deposit"><?php echo e(_i('Minimum deposit')); ?></label>
                                    <input type="text" name="min_deposit" id="min_deposit" class="form-control" value="<?php echo e($campaign->data->min ?? ''); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 deposits-options <?php echo e(!isset($campaign->data->deposit_options) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    <label for="deposit_options"><?php echo e(_i('Deposit options')); ?></label>
                                    <select name="deposit_options" id="deposit_options" class="form-control" disabled>
                                        <option value="<=" <?php echo e(isset($campaign->data->deposit_options) && $campaign->data->deposit_options == '<=' ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Less than')); ?>

                                        </option>
                                        <option value=">=" <?php echo e(isset($campaign->data->deposit_options) && $campaign->data->deposit_options == '>=' ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Greater than')); ?>

                                        </option>
                                        <option value="==" <?php echo e(isset($campaign->data->deposit_options) && $campaign->data->deposit_options == '==' ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Same to')); ?>

                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 deposits-quantity <?php echo e(!isset($campaign->data->deposits_quantity) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    <label for="deposits_quantity"><?php echo e(_i('Quantity of deposits')); ?></label>
                                    <input type="number" class="form-control" name="deposits_quantity" id="deposits_quantity" autocomplete="off" value="<?php echo e($campaign->data->deposits_quantity ?? ''); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 payments <?php echo e(!isset($campaign->data->min) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    <label for="include_payment_methods"><?php echo e(_i('Include payment methods')); ?></label>
                                    <select name="include_payment_methods[]" id="include_payment_methods" class="form-control select2" multiple disabled>
                            ...
                            <div class="col-md-4 payments <?php echo e(!isset($campaign->data->min) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    ...
                                    <select name="exclude_payment_methods[]" id="exclude_payment_methods" class="form-control select2" multiple disabled>
                                        <option value=""><?php echo e(_i('Select...')); ?></option>
                                        <?php $__currentLoopData = $payment_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($payment_method->id); ?>">
                                                <?php echo e($payment_method->name); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="complete_rollovers" id="complete_rollovers" class="form-control" disabled>
                                        <option value="true" <?php echo e($campaign->data->rollovers ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Yes')); ?>

                                        </option>
                                        <option value="false" <?php echo e(!$campaign->data->rollovers ? 'selected' : ''); ?>>
                                            <?php echo e(_i('No')); ?>
                            ...
                            <div class="col-md-4 rollovers-data <?php echo e(is_null($rollovers) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    ...
                                    <select name="include_deposit" id="include_deposit" class="form-control" disabled>
                                        <option value="true" <?php echo e(!is_null($rollovers) && $rollovers->include_deposit ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Deposit')); ?>

                                        </option>
                                        <option value="false" <?php echo e(!is_null($rollovers) && !$rollovers->include_deposit ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Bonus')); ?>

                                        </option>
                                        <option value="1" <?php echo e(!is_null($rollovers) && is_null($rollovers->include_deposit) ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-4 rollovers-data <?php echo e(is_null($rollovers) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    ...
                                    <select name="provider_type" id="provider_type" data-route="<?php echo e(route('bonus-system.campaigns.exclude-providers')); ?>" class="form-control" disabled>
                            ...
                            <div class="col-md-4 rollovers-data <?php echo e(is_null($rollovers) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="multiplier" id="multiplier" class="form-control" value="<?php echo e(!is_null($rollovers) ? $rollovers->multiplier : ''); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 rollovers-data <?php echo e(is_null($rollovers) ? 'd-none' : ''); ?>">
                                <div class="form-group">
                                    <label for="days"><?php echo e(_i('Days to complete rollover')); ?></label>
                                    <input type="text" name="days" id="days" class="form-control" value="<?php echo e(!is_null($rollovers) ? $rollovers->days : ''); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 sports <?php echo e(!is_null($rollovers) ? $rollovers->provider_type_id != \Dotworkers\Configurations\Enums\ProviderTypes::$sportbook ? 'd-none' : '' : 'd-none'); ?>">
                                <div class="form-group">
                                    ...
                                    <select name="bet_type" id="bet_type" class="form-control" disabled>
                                        <option value="true" <?php echo e(isset($campaign->data->simple) && $campaign->data->simple == 'true' ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Simple')); ?>

                                        </option>
                                        <option value="false" <?php echo e(isset($campaign->data->simple) && $campaign->data->simple == 'false' ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Combined')); ?>

                                        </option>
                                        <option value="1" <?php echo e(isset($campaign->data->simple) && $campaign->data->simple == 'null' ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-4 sports <?php echo e(!is_null($rollovers) ? $rollovers->provider_type_id != \Dotworkers\Configurations\Enums\ProviderTypes::$sportbook ? 'd-none' : '' : 'd-none'); ?>">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="odd" id="odd" class="form-control" value="<?php echo e($campaign->data->odd ?? ''); ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-10">
                    ...
                    <div class="card-block g-pa-15">
                        <div class="col-md-12 bonus <?php echo e(!isset($campaign->data->amount) ? 'd-none' : ''); ?>">
                            <div class="form-group">
                                <label for="bonus"><?php echo e(_i('Bonus to be awarded')); ?></label>
                                <input type="text" name="bonus" id="bonus" class="form-control" value="<?php echo e($campaign->data->amount ?? ''); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-12 deposit-percentage <?php echo e(!isset($campaign->data->percentage) ? 'd-none' : ''); ?>">
                            <div class="form-group">
                                <label for="percentage"><?php echo e(_i('Deposit percentage')); ?></label>
                                <input type="text" name="percentage" id="percentage" class="form-control" value="<?php echo e(isset($campaign->data->percentage) ? $campaign->data->percentage * 100 : ''); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-12 bonus-limit <?php echo e(!isset($campaign->data->limit) ? 'd-none' : ''); ?>">
                            <div class="form-group">
                                <label for="limit"><?php echo e(_i('Bonus limit to be awarded')); ?></label>
                                <input type="text" name="limit" id="limit" class="form-control" value="<?php echo e($campaign->data->limit ?? ''); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="max_balance_convert"><?php echo e(_i('Amount that can be converted into a real balance')); ?></label>
                                <input type="text" name="max_balance_convert" id="max_balance_convert" class="form-control" value="<?php echo e($campaign->data->max_balance_convert ?? ''); ?>" placeholder="<?php echo e(_i('Optional')); ?>" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-10">
                    ...
                    <div class="card-block g-pa-15">
                        ...
                        <select name="versions" id="versions" data-route="<?php echo e(is_null($campaign->original_campaign) ? route('bonus-system.campaigns.edit', [$campaign->id]) : route('bonus-system.campaigns.edit', [$campaign->original_campaign])); ?>" class="form-control">
                            <option value=""><?php echo e(_i('Select...')); ?></option>
                            <?php $__currentLoopData = $versions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $version): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($version->id_campaign); ?>" <?php echo e($campaign->version == $version->version ? 'selected' : ''); ?>>
                        ...
                        <div class="col-md-12">
                            <div class="search-users <?php echo e(isset($campaign->data->users_restriction_type) && $campaign->data->users_restriction_type == 'users' ? '' : 'd-none'); ?>">
                                <div class="form-group">
                                    ...
                                    <select name="include_users[]" id="include_users" class="form-control select2" data-route="<?php echo e(route('users.search-username')); ?>" multiple disabled>
                                        <option></option>
                                    </select>
                                </div>
                            </div>
                            <div class="search-users <?php echo e(isset($campaign->data->users_restriction_type) && $campaign->data->users_restriction_type == 'users' ? '' : 'd-none'); ?>">
                                <div class="form-group">
                                    ...
                                    <select name="exclude_users[]" id="exclude_users" class="form-control select2" data-route="<?php echo e(route('users.search-username')); ?>" multiple disabled>
                                        <option></option>
                                    </select>
                                </div>
                            </div>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(function () {
            ...
            bonusSystem.fillRestrictionSelect('#include_users', <?php echo json_encode($campaign->include_users, 15, 512) ?>)
            <?php endif; ?>

            <?php if(isset($campaign->exclude_users)): ?>
            bonusSystem.fillRestrictionSelect('#exclude_users', <?php echo json_encode($campaign->exclude_users, 15, 512) ?>)
            <?php endif; ?>

            <?php if(isset($campaign->include_segments)): ?>
            bonusSystem.fillRestrictionSelect('#include_segments', <?php echo json_encode($campaign->include_segments, 15, 512) ?>)
            <?php endif; ?>

            <?php if(isset($campaign->exclude_segments)): ?>
            bonusSystem.fillRestrictionSelect('#exclude_segments', <?php echo json_encode($campaign->exclude_segments, 15, 512) ?>)
            <?php endif; ?>

            <?php if(isset($campaign->include_payment_methods)): ?>
            bonusSystem.fillPaymentMethodsSelect('#include_payment_methods', <?php echo json_encode($campaign->include_payment_methods, 15, 512) ?>)
            <?php endif; ?>

            <?php if(isset($campaign->exclude_payment_methods)): ?>
            bonusSystem.fillPaymentMethodsSelect('#exclude_payment_methods', <?php echo json_encode($campaign->exclude_payment_methods, 15, 512) ?>)
            <?php endif; ?>
        });
    </script>
<?php $__env->stopSection(); ?>
