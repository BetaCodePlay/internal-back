    ...
    <div class="row">
        <div class="col-md-3">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <form action="<?php echo e(route('notifications.groups.assign.data')); ?>" id="assign-user-form" method="post" enctype="multipart/form-data">
                    <div class="card-block g-pa-15">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="group" id="group" value="<?php echo e($group); ?>">
            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered w-100" id="group-user-table" data-route="<?php echo e(route('notifications.groups.users', [ $group ])); ?>">
                            <thead>
                            <tr>
