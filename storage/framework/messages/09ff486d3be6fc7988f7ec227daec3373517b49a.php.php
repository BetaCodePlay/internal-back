...
<?php $__env->startSection('content'); ?>
    <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
        <header class="card-header g-bg-transparent g-brd-gray-light-v7 g-px-15 g-pt-15 g-pt-20--sm g-pb-10 g-pb-15--sm">
            <div class="media">
                ...
                <div class="media-body d-flex justify-content-end">
                    <a href="<?php echo e(route('email-templates.index')); ?>" class="btn u-btn-3d u-btn-primary float-right">
        ...
        <form action="<?php echo e(route('email-templates.store')); ?>" id="email-templates-form" method="post">
            <div class="card-block g-pa-15">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="hidden" name="email_templates_type_id" id="email_templates_type_id" value="<?php echo e($email_templates_type_id); ?>">
