...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    <table class="table table-bordered table-responsive-sm w-100" id="personal-cancel-table" data-route="<?php echo e(route('betpay.personal.cancel.data')); ?>">
                        <thead>
                        <tr>
    ...
    <?php echo $__env->make('back.betpay.personal.modals.process-payment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
