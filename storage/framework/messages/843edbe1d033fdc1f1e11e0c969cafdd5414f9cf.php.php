                                    ...
                                    <div class="form-check">
                                        <label class="u-check g-pl-25">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="allocation_criteria[]"
                                                ...
                                                <?php echo e(in_array(\Dotworkers\Bonus\Enums\AllocationCriteria::$registration, $campaign->data->allocation_criteria) ? 'checked' : ''); ?> disabled>
                                    ...
                                    <div class="form-check">
                                        <label class="u-check g-pl-25">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="allocation_criteria[]"
                                                ...
                                                <?php echo e(in_array(\Dotworkers\Bonus\Enums\AllocationCriteria::$complete_profile, $campaign->data->allocation_criteria) ? 'checked' : ''); ?> disabled>
                                            <div class="u-check-icon-checkbox-v4 g-absolute-centered--y g-left-0">
                                                <i class="fa" data-check-icon="&#xf00c"></i>
                                            </div>
                                    ...
                                    <div class="form-check">
                                        <label class="u-check g-pl-25 <?php echo e(!in_array(\Dotworkers\Bonus\Enums\AllocationCriteria::$deposit, $campaign->data->allocation_criteria) ? 'disabled' : ''); ?>">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="allocation_criteria[]"
                                                ...
                                                <?php echo e(!in_array(\Dotworkers\Bonus\Enums\AllocationCriteria::$deposit, $campaign->data->allocation_criteria) ? 'disabled' : ''); ?> disabled>
                                            <div class="u-check-icon-checkbox-v4 g-absolute-centered--y g-left-0">
                                                <i class="fa" data-check-icon="&#xf00c"></i>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" name="min_deposit" class="form-control" value="<?php echo e(isset($campaign->data->min) ? $campaign->data->min : ''); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                    ...
                                    <div class="form-group g-mb-10">
                                        <label class="u-check g-pl-25">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" name="bonus_type_awarded" id="fixed-bonus" type="radio"
                                                ...
                                                <?php echo e($campaign->bonus_type_id == \Dotworkers\Bonus\Enums\BonusTypeAwarded::$fixed ? 'checked' : ''); ?> disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 fixed-bonus <?php echo e($campaign->data->bonus_type_awarded != \Dotworkers\Bonus\Enums\BonusTypeAwarded::$fixed ? 'd-none' : ''); ?>">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" name="bonus" class="form-control" value="<?php echo e($campaign->data->bonus ?? ''); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4 deposit-percentage <?php echo e($campaign->data->bonus_type_awarded != \Dotworkers\Bonus\Enums\BonusTypeAwarded::$percentage ? 'd-none' : ''); ?>">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" name="percentage" class="form-control" value="<?php echo e(isset($campaign->data->percentage) ? $campaign->data->percentage * 100 : ''); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4 deposit-percentage <?php echo e($campaign->data->bonus_type_awarded != \Dotworkers\Bonus\Enums\BonusTypeAwarded::$percentage ? 'd-none' : ''); ?>">
                                            <div class="form-group">
                                                <label for="limit"><?php echo e(_i('Limit to be awarded')); ?></label>
                                                <input type="number" min="0" name="limit" class="form-control" value="<?php echo e($campaign->data->limit ?? ''); ?>" readonly >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="max_balance_convert"><?php echo e(_i('Maximum to convert into real balance')); ?></label>
                                                <input type="number" min="0" name="max_balance_convert" class="form-control" placeholder="<?php echo e(_i('Optional')); ?>" value="<?php echo e($campaign->data->max_balance_convert); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <div class="col-md-4 sports <?php echo e(!is_null($rollovers) ? $rollovers->provider_type_id != \Dotworkers\Configurations\Enums\ProviderTypes::$sportbook ? 'd-none' : '' : 'd-none'); ?>">
                                <div class="form-group">
                                    ...
                                    <select name="bet_type" id="bet_type" class="form-control" disabled>
                                        ...
                                        <option value="true" <?php echo e(isset($campaign->data->simple) && $campaign->data->simple ? 'selected' : ''); ?>>
                                            <?php echo e(_i('Simple')); ?>

                                        </option>
                                        <option value="false" <?php echo e(isset($campaign->data->simple) && !$campaign->data->simple ? 'selected' : ''); ?>>
