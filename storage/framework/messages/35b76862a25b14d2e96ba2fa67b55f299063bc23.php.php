<div id="sideNav" class="col-auto u-sidebar-navigation-v1 u-sidebar-navigation--dark">
    ...
    <div class="col-social-navigation">
        <?php if(\Dotworkers\Configurations\Configurations::getWhitelabel() == 20 || \Dotworkers\Configurations\Configurations::getWhitelabel() == 11): ?>
        ...
        <?php elseif(\Dotworkers\Configurations\Configurations::getWhitelabel() == 25): ?>
            <a class="color-telegram" href="https://t.me/+uc7jrJU0DfY0NTcx" target="_blank"><i class="fa fa-telegram"></i> <span class="social-name">Canal Publicitario</span></a>
        <?php else: ?>
