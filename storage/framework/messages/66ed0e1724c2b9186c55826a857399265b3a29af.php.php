            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered w-100" id="free-spins-list-table" data-route="<?php echo e(route('dot-suite.free-spins.triple-cherry.free-spins-list')); ?>">
                            <thead>
                            <tr>
