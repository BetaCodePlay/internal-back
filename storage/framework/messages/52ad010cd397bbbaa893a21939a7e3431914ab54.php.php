...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('notifications.groups.store')); ?>" id="notifications-groups-form" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
