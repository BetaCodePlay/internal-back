<div class="modal fade" id="process-debit-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo e(route('betpay.monnet.process-debit')); ?>" method="post" id="process-debit-form">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="payment_method" value="<?php echo e(\Dotworkers\Configurations\Enums\PaymentMethods::$monnet); ?>">
                    <input type="hidden" name="provider" value="<?php echo e(\Dotworkers\Configurations\Enums\Providers::$monnet); ?>">
