                    ...
                    <header
                        ...
                        <div class="media">
                            ...
                            <div class="media-body d-flex justify-content-end">
                                <a href="<?php echo e(route('bonus-system.campaigns.index')); ?>"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="internal_name" id="internal_name"
                                        ...
                                        value="<?php echo e($campaign->name); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start_date" id="start_date"
                                        ...
                                        value="<?php echo e($campaign->start); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="end_date" id="end_date" class="form-control datetimepicker"
                                        autocomplete="off" value="<?php echo e($campaign->end); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="currency" id="currency" class="form-control input_placeholder"
                                        data-route="<?php echo e(route('bonus-system.campaigns.provider-types')); ?>"
                                        data-payments-route="<?php echo e(route('bonus-system.campaigns.payment-methods')); ?>">
                                        <?php $__currentLoopData = $whitelabel_currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($currency->iso); ?>"
                                                <?php echo e($currency->iso == $campaign->currency_iso ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="allocation_criteria[]" id="allocation_criteria" class="form-control"
                                        data-route="<?php echo e(route('bonus-system.campaigns.allocation-criteria-all')); ?>">
                                        ...
                                        <?php $__currentLoopData = $criterias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($criteria->id); ?>"
                                                <?php echo e($criteria->id == $campaign->data->allocation_criteria[0] ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo e(_i('Commission real balance(%)')); ?>
                                        ...
                                        <i class="fa fa-info-circle" aria-hidden="true" data-container="body"
                                            ...
                                            data-content="<?php echo e(_i('Assign the percentage of your actual balance that you want to spend along with the bonus')); ?>">
                                        </i>
                                    </label>
                                    <input type="text" name="commission_real" id="commission_real"
                                        onkeyup="BonusSystem.updateCommissionBonus()" class="form-control"
                                        value="<?php echo e($campaign->data->commission_real); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for=""><?php echo e(_i('Commission bonus balance(%)')); ?>
                                        ...
                                        <i class="fa fa-info-circle" aria-hidden="true" data-container="body"
                                            data-toggle="popover" data-placement="top" data-trigger="hover"
                                            data-content="<?php echo e(_i('Assign the percentage of bonus balance you want to spend along with the actual balance')); ?>">
                                        </i>
                                    </label>
                                    <input type="text" name="commission_bonus_v" id="commission_bonus_v"
                                        class="form-control" value="<?php echo e($campaign->data->commission_bonus); ?>" disabled>
                                    <input type="hidden" name="commission_bonus" id="commission_bonus"
                                        class="form-control" value="<?php echo e($campaign->data->commission_bonus); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table align-middle g-mb-0">
                            <tr>
                                <td width="20%">
                                    ...
                                    <div class="form-group g-mb-10">
                                        <label
                                            class="u-check g-pl-25 <?php echo e(!in_array(\Dotworkers\Bonus\Enums\AllocationCriteria::$deposit, $campaign->data->allocation_criteria) ? 'disabled' : ''); ?>">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0"
                                ...
                                <td>
                                    <div class="row">
                                        <div
                                            class="col-md-4 fixed-bonus <?php echo e($campaign->data->bonus_type_awarded != \Dotworkers\Bonus\Enums\BonusTypeAwarded::$fixed ? 'd-none' : ''); ?>">
                                            <div class="form-group">
                                                <label for="bonus"><?php echo e(_i('Bonus to be awarded')); ?></label>
                                                <input type="number" min="0" name="bonus" class="form-control"
                                                    value="<?php echo e($campaign->data->bonus ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div
                                            class="col-md-4 deposit-percentage <?php echo e($campaign->data->bonus_type_awarded != \Dotworkers\Bonus\Enums\BonusTypeAwarded::$percentage ? 'd-none' : ''); ?>">
                                            <div class="form-group">
                                                <label for="percentage"><?php echo e(_i('Percentage')); ?></label>
                                                <input type="text" name="percentage"
                                                    class="form-control"
                                                    value="<?php echo e(isset($campaign->data->percentage) ? $campaign->data->percentage  : ''); ?>">
                                            </div>
                                        </div>
                                        <div
                                            class="col-md-4 deposit-percentage <?php echo e($campaign->data->bonus_type_awarded != \Dotworkers\Bonus\Enums\BonusTypeAwarded::$percentage ? 'd-none' : ''); ?>">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" name="limit" class="form-control"
                                                    value="<?php echo e($campaign->data->limit ?? ''); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label
                                                    for="max_balance_convert"><?php echo e(_i('Maximum to convert into real balance')); ?></label>
                                                <input type="number" min="0" name="max_balance_convert"
                                                    class="form-control" placeholder="<?php echo e(_i('Optional')); ?>"
                                                    value="<?php echo e($campaign->data->max_balance_convert); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="#add-translations-modal" data-toggle="modal"
                                            ...
                                            data-language="<?php echo e($language['name']); ?>"
                                            data-language-iso="<?php echo e($language['iso']); ?>">
                                            <i class="hs-admin-plus"></i>
                                            <?php echo e(_i('Add')); ?>
