        ...
        <div class="col">
            <div class="noty_bar noty_type__warning noty_theme__unify--v1--dark g-mb-25">
                <div class="noty_body">
                    ...
                    <div>
                        <p>
                            <?php echo e(_i('This report shows the list of bonus transactions that have been executed manually to the user or by claiming a bonus by the user.')); ?>
                ...
                <div class="card-block g-pa-15">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered w-100" id="bonus-transactions-table"
                               data-route="<?php echo e(route('reports.financial.bonus-transactions-data')); ?>">
                            <thead>
                            <tr>
