    ...
    <div class="offset-md-4 offset-lg-6 offset-xl-6 col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
        <div class="form-group">
            <select name="status" id="status" class="form-control">
                ...
                <option value="<?php echo e(\Dotworkers\Configurations\Enums\TransactionStatus::$processing); ?>"><?php echo e(_i('Processing')); ?></option>
                <option value="<?php echo e(\Dotworkers\Configurations\Enums\TransactionStatus::$rejected); ?>"><?php echo e(_i('Rejected')); ?></option>
                <option value="<?php echo e(\Dotworkers\Configurations\Enums\TransactionStatus::$rejected_by_bank); ?>"><?php echo e(_i('Rejected by bank')); ?></option>
            </select>
        </div>
    </div>
