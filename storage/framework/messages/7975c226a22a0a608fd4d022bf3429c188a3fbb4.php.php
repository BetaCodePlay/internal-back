...
<li class="u-sidebar-navigation-v1-menu-item u-side-nav--top-level-menu-item has-active">
    <a class="media u-side-nav--top-level-menu-link u-side-nav--hide-on-hidden" href="javascript:void(0)"
       data-toggle="collapse" data-target="#sliderSidebar" aria-expanded="true">
        <span class="g-pos-rel"><i class="hs-admin-gallery"></i></span> <span
            class="media-body align-self-center"><?php echo e(_i('Sliders')); ?></span>
    ...
    <ul id="sliderSidebar"
        ...
        <?php $__currentLoopData = $sliderSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionKey => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--second-level-menu-item">
                <a class="media u-side-nav--second-level-menu-link" href="javascript:void(0)" target="_self"
                   data-toggle="collapse" data-target="#sliderActionSidebar-<?php echo e($sectionKey); ?>" aria-expanded="false">
                    <span class="media-body align-self-center"><?php echo e($slider->text); ?></span>
                    <span class="icon-mobile"><i class="fa-solid fa-chevron-down"></i></span>
                </a>
                <ul id="sliderActionSidebar-<?php echo e($sectionKey); ?>"
