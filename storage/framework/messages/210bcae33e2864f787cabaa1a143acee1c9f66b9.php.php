...
class Version
{
     ...
     */
    public static function campaignVersion($request)
    {
        try {
            ...
            foreach ($requestData as $data) {
                switch ($data) {
                    case $request->start_date:
                    {
                        ...
                        if ($requestStartDate != $campaignData->start_date) {
                            $version = true;
                        }
                        break;
                    }
                    ...
                    case $request->end_date:
                    {
                        ...
                        if ($requestEndDate != $campaignData->end_date) {
                            $version = true;
                        }
                        break;
                    }
                    ...
                    {
                        if ($request->currency != $campaignData->currency_iso) {
                            $version = true;
                        }
                        break;
                    }
                    ...
                    case $request->deposit_type:
                    {
                        if (isset($campaignData->data->deposit_type)) {
                            if ($request->deposit_type != $campaignData->data->deposit_type) {
                                $version = true;
                            }
                        }
                        break;
                    ...
                    case $request->provider_type:
                    {
                        if (!is_null($rolloversData)) {
                            ...
                            if (!is_null($request->provider_type) && $request->complete_rollovers == 'true') {
                                $version = true;
                            }
                        }
                        break;
                    ...
                    default:
                    {
                        $completeRollovers = $request->complete_rollovers == 'true';
