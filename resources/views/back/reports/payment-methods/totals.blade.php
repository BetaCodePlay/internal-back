...
@section('content')
        ...
        <div class="col">
            <div class="noty_bar noty_type__warning noty_theme__unify--v1--dark g-mb-25">
                <div class="noty_body">
                    ...
                    <div>
                        <p>
                            {{ _i('This report shows the total deposits and withdrawals, both pending and approved, for each activated payment method in the selected currency.') }}
                        </p>
                        <p>
                            {{ _i('Transactions made through agents or manual transactions are not reflected in this report.') }}
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="row {{ count($currencies) > 1 ? 'totals d-none' : '' }}">
            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="currency" id="currency" class="form-control">
                                    @foreach ($currency_client as $currency)
                                        <option value="{{ $currency }}" {{ $currency == session('currency') ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="payment_method">{{ _i('Payment method') }}</label>
                                <select name="payment_method" id="payment_method" class="form-control">
                                    <option value="">{{ _i('All') }}</option>
                                    @foreach ($payment_methods as $payment)
                                        <option value="{{ $payment['id'] }}">
                                            {{ \Dotworkers\Configurations\Enums\PaymentMethods::getName($payment['id']) }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
            ...
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    ...
                    <table class="table table-bordered table-responsive-sm w-100" id="payment-totals-table"
                           data-route="{{ route('reports.payment-methods.totals-data') }}">
                        <thead>
                        <tr>
