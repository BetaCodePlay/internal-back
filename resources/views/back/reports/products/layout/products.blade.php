<div class="noty_bar noty_type__warning noty_theme__unify--v1 g-mb-25">
    <div class="noty_body">
        ...
        <div>
            ...
            <br>
            {{ _i('If you want to see data in real time please use the product reports') }}
        </div>
    </div>
</div>
<div class="row">
            ...
            <div class="card-block g-pa-15">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md type">
                        <div class="form-group">
                            <label for="type">{{ _i('Provider type') }}</label>
                            <select name="type" id="type" class="form-control">
                                <option value="">{{ _i('All provider types') }}</option>
                                @foreach($providers_types as $providers_type)
                                    <option value="{{ $providers_type->id }}">
                                        {{ $providers_type->name }}
                                    </option>
                                @endforeach
                            </select>
        ...
        <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
            <div class="card-block g-pa-15">
                ...
                <table class="table table-bordered table-responsive-sm w-100" id="products-totals-table"
                       data-route="{{ route('reports.products-totals-data') }}">
                    <thead>
                    <tr>
