...
@section('content')
        ...
        <div class="col">
            <div class="noty_bar noty_type__warning noty_theme__unify--v1--dark g-mb-25">
                <div class="noty_body">
                    ...
                    <div>
                        <p>
                            {{ _i('This report shows the list of withdrawals made in a certain date range, allowing them to be filtered by status.') }}
                        </p>
                        <p>
    ...
    <input type="hidden" id="transaction_type" value="{{ \Dotworkers\Configurations\Enums\TransactionTypes::$debit }}">
