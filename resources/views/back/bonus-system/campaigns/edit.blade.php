...
@section('content')
    <form action="{{ route('bonus-system.campaigns.update') }}" id="campaigns-form" method="post" enctype="multipart/form-data" novalidate>
        <div class="row">
            <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="internal_name" id="internal_name" class="form-control" value="{{ $campaign->name }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="start_date">{{ _i('Start date') }}</label>
                                    <input type="text" name="start_date" id="start_date" class="form-control datetimepicker" autocomplete="off" value="{{ $campaign->start }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="end_date">{{ _i('Finish date') }}</label>
                                    <input type="text" name="end_date" id="end_date" class="form-control datetimepicker" autocomplete="off" value="{{ $campaign->end }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="currency">{{ _i('Currency') }}</label>
                                    <select name="currency" id="currency" class="form-control" data-route="{{ route('bonus-system.campaigns.provider-types') }}" data-payments-route="{{ route('bonus-system.campaigns.payment-methods') }}">
                                    ...
                                    <div class="form-check">
                                        <label class="u-check g-pl-25">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="allocation_criteria[]"
                                                ...
                                                {{ in_array(\Dotworkers\Bonus\Enums\AllocationCriteria::$registration, $campaign->data->allocation_criteria) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <label class="u-check g-pl-25">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="allocation_criteria[]"
                                                ...
                                                {{ in_array(\Dotworkers\Bonus\Enums\AllocationCriteria::$complete_profile, $campaign->data->allocation_criteria) ? 'checked' : '' }}>
                                            <div class="u-check-icon-checkbox-v4 g-absolute-centered--y g-left-0">
                                                <i class="fa" data-check-icon="&#xf00c"></i>
                                            </div>
                                            {{ _i('Complete profile') }}
                                    ...
                                    <div class="form-check">
                                        <label class="u-check g-pl-25 {{ !in_array(\Dotworkers\Bonus\Enums\AllocationCriteria::$deposit, $campaign->data->allocation_criteria) ? 'disabled' : '' }}">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="allocation_criteria[]"
                                                ...
                                                {{ !in_array(\Dotworkers\Bonus\Enums\AllocationCriteria::$deposit, $campaign->data->allocation_criteria) ? 'disabled' : '' }}>
                                            <div class="u-check-icon-checkbox-v4 g-absolute-centered--y g-left-0">
                                                <i class="fa" data-check-icon="&#xf00c"></i>
                                            </div>
                                            {{ _i('Deposits') }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" name="min_deposit" class="form-control" value="{{ isset($campaign->data->min) ? $campaign->data->min : '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 fixed-bonus {{ $campaign->data->bonus_type_awarded != \Dotworkers\Bonus\Enums\BonusTypeAwarded::$fixed ? 'd-none' : '' }}">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" name="bonus" class="form-control" value="{{ $campaign->data->bonus ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4 deposit-percentage {{ $campaign->data->bonus_type_awarded != \Dotworkers\Bonus\Enums\BonusTypeAwarded::$percentage ? 'd-none' : '' }}">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" name="percentage" class="form-control" value="{{ isset($campaign->data->percentage) ? $campaign->data->percentage * 100 : '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4 deposit-percentage {{ $campaign->data->bonus_type_awarded != \Dotworkers\Bonus\Enums\BonusTypeAwarded::$percentage ? 'd-none' : '' }}">
                                            <div class="form-group">
                                                <label for="limit">{{ _i('Limit to be awarded') }}</label>
                                                <input type="number" min="0" name="limit" class="form-control" value="{{ $campaign->data->limit ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="max_balance_convert">{{ _i('Maximum to convert into real balance') }}</label>
                                                <input type="number" min="0" name="max_balance_convert" class="form-control" placeholder="{{ _i('Optional') }}" value="{{ $campaign->data->max_balance_convert }}">
                                            </div>
                                        </div>
                                    </div>
                                </td>
