    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <form action="{{ route('users.transactions-by-lot-file') }}" id="transactions-by-lot-form" method="post" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <div class="card-block g-pa-15">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="transactions-by-lot-file">{{ _i('Transactions file') }}</label>
                                        <div class="form-group">
