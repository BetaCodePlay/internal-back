        ...
        <div class="modal-content">
            <form action="{{ route('betpay.process-credit') }}" method="post" id="process-credit-form">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="payment_method" value="{{ \Dotworkers\Configurations\Enums\PaymentMethods::$red_pagos }}">
                    <input type="hidden" name="provider" value="{{ \Dotworkers\Configurations\Enums\Providers::$red_pagos }}">
