        ...
        <div class="modal-content">
            <form action="{{ route('betpay.process-debit') }}" method="post" id="process-debit-form">
                        ...
                        <select name="client_account" id="client_account" class="form-control">
                            ...
                            @foreach ($accounts as $account)
                                <option value="{{ $account->id }}">
                                    {{ $account->data->cryptocurrency }} - {{ $account->data->wallet }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="payment_method" value="{{ \Dotworkers\Configurations\Enums\PaymentMethods::$cryptocurrencies }}">
                    <input type="hidden" name="provider" value="{{ \Dotworkers\Configurations\Enums\Providers::$cryptocurrencies }}">
