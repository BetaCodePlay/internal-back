            ...
            <form action="{{ route('betpay.process-debit') }}" method="post" id="process-debit-form">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <p>
                                <strong>{{ _i('Bank details of the user') }}</strong>
                            </p>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="bank">{{ _i('Account from where you made the payment') }}</label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="reference">{{ _i('Bank reference') }}</label>
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="payment_method" value="{{ \Dotworkers\Configurations\Enums\PaymentMethods::$wire_transfers }}">
                    <input type="hidden" name="provider" value="{{ \Dotworkers\Configurations\Enums\Providers::$wire_transfers }}">
