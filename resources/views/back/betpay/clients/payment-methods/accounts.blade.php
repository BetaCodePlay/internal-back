    ...
    <div class="row">
                ...
                <div class="card-block g-pa-15">
                    <form action="{{ route('configurations.credentials.store') }}" id="save-form" method="post">
                        <div class="row">
                            ...
                            @if ($provider == \Dotworkers\Configurations\Enums\Providers::$wire_transfers)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if ($provider == \Dotworkers\Configurations\Enums\Providers::$credit_codes)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="credential">{{ _i('Client token') }}</label>
                                        <input type="text" name="client_token" id="client_token" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$cryptocurrencies)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$just_pay)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$zelle)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="credential">{{ _i('Client token') }}</label>
                                        <input type="text" name="client_token" id="client_token" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$mobile_payment)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$paypal)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="operator_id">{{ _i('Operator ID') }}</label>
                                        <input type="text" name="operator_id" id="operator_id" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$skrill)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$neteller)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$airtm)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="operator_id">{{ _i('Operator ID') }}</label>
                                        <input type="text" name="operator_id" id="operator_id" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$uphold)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$apcopay)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$yeipii)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$pago_123)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="credential">{{ _i('Client token') }}</label>
                                        <input type="text" name="client_token" id="client_token" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$zippy)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="private_key">{{ _i('Private key') }}</label>
                                        <input type="text" name="private_key" id="private_key" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$paycips)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="private_key">{{ _i('Private key') }}</label>
                                        <input type="text" name="private_key" id="private_key" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$total_pago)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="client_id">{{ _i('Client ID') }}</label>
                                        <input type="text" name="client_id" id="client_id" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$monnet)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="client_id">{{ _i('Client ID') }}</label>
                                        <input type="text" name="client_id" id="client_id" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$oobit)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="client_id">{{ _i('Client ID') }}</label>
                                        <input type="text" name="client_id" id="client_id" class="form-control">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$ves_to_usd)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$vcreditos)
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            @endif
                            @if($provider == \Dotworkers\Configurations\Enums\Providers::$vpos)
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="url_launch">{{ _i('Url Launch') }}</label>
        ...
        <div class="col-md-12">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    <table class="table table-bordered table-responsive-sm w-100" id="client-account-table" data-route="{{ route('configurations.credentials.data') }}">
                        <thead>
                        <tr>
