...
<div id="sideNav" class="col-auto u-sidebar-navigation-v1 u-sidebar-navigation--dark">
    <ul id="sideNavMenu" class="u-sidebar-navigation-v1-menu u-side-nav--top-level-menu mb-0">
        ...
        @can('access', [\Dotworkers\Security\Enums\Permissions::$users_search])
            ...
            <li class="u-sidebar-navigation-v1-menu-item u-side-nav--top-level-menu-item has-active">
                <form id="header-search-form" class="u-header--search" action="{{ route('users.search') }}" method="get" autocomplete="off">
                    <div class="input-group">
                        <input class="form-control form-control-sidebar" type="text" name="username" placeholder="{{ _i('Search user') }}" autocomplete="off" value="">
