    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    <form action="" id="store-form" method="post">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="change_provider">{{ _i('Provider') }}</label>
                                    <select name="change_provider" id="change_provider" data-route="" class="form-control">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="games">{{ _i('Maker') }}</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="balance">{{ _i('Amount') }}</label>
                                    <input type="number" name="balance" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="balance">{{ _i('Load Amount') }}</label>
                                    <input type="number" name="balance" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="balance">{{ _i('Limit') }}</label>
                                    <input type="number" name="balance" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="card g-brd-gray-light-v7 g-rounded-4 g-mb-30">
                ...
                <div class="card-block g-pa-15">
                    <table class="table table-bordered table-responsive-sm w-100" id="games-table"  data-route="">
                        <thead>
                        <tr>
