...
@section('content')
    <form action="{{ route('featured-sliders.update') }}" id="sliders-form" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6">
                    ...
                    <header
                        ...
                        <div class="media">
                            ...
                            <div class="media-body d-flex justify-content-end">
                                <a href="{{ route('featured-sliders.index', [$slider->element_type_id]) }}" class="btn u-btn-3d u-btn-primary float-right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start_date" id="start_date"
                                           class="form-control datepicker" value="{{ $slider->start }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="end_date">{{ _i('Finish date') }}</label>
                                    <input type="text" name="end_date" id="end_date" class="form-control datepicker" value="{{ $slider->end }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="device" id="device" class="form-control">
                                        <option value="*" {{ $slider->mobile == '*' ? 'selected' : '' }}>{{ _i('All') }}</option>
                                        <option value="false" {{ !$slider->mobile ? 'selected' : '' }}>{{ _i('Desktop') }}</option>
                                        <option value="true" {{ $slider->mobile ? 'selected' : '' }}>{{ _i('Mobile') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="language" id="language" class="form-control">
                                        ...
                                        @foreach ($languages as $language)
                                            <option value="{{ $language['iso'] }}" {{ $slider->language == $language['iso'] ? 'selected' : '' }}>
                                                {{ $language['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="currency" id="currency" class="form-control">
                                        <option value="*" {{ $slider->currency == '*' ? 'selected' : '' }}>
                                            {{ _i('All') }}
                                        </option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="template_element_type" value="{{ $slider->element_type_id }}">
