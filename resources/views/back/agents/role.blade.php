        ...
        <div class="d-none" id="user-buttons">
            <div class="d-inline-block dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownRoleProfile">
                    ...
                    <li><a class="dropdown-item currentDataRole" href="javascript:void(0)" data-toggle="modal" data-target="#role-lock" data-lock="{{ _i('Lock profile') }}" data-unlock="{{ _i('Unlock profile') }}" data-value=""></a></li>
