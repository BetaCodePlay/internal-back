...
@section('content')
    <form action="{{ route('store.rewards.store') }}" id="rewards-form" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="false">{{ _i('No active') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="category">{{ _i('Category (optional)') }}</label>
