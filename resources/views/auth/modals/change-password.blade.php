        ...
        <div class="reset-password-content">
            <div class="reset-password-content-ex">
                ...
                <div class="reset-password-body">
                    ...
                    <button type="button" class="btn-send" id="send-reset-password" data-route="{{ route('auth.change-password') }}" data-loading-text="<i class='fa fa-spin fa-spinner'></i> {{ _i('Please wait...') }}">
                        {{ _i('Reset') }}
                    </button>
                </div>
            </div>
