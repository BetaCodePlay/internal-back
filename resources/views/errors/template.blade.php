...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('back/css/vendor.min.css') }}">
    <link rel="stylesheet" href="{{ asset('back/css/custom.min.css') }}?v=2">
    <link rel="stylesheet"
...
<script src="{{ asset('back/js/scripts.min.js') }}"></script>
</body>
</html>
